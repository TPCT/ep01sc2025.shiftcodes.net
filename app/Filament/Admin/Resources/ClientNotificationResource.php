...
use App\Filament\Admin\Resources\ClientNotificationResource\Pages;
use App\Filament\Admin\Resources\ClientNotificationResource\RelationManagers;
...
class ClientNotificationResource extends Resource
{
    ...
    protected static ?string $model = ClientNotification\ClientNotification::class;
    ...
    {
        return __("Client Notifications");
    }
                    ...
                    Forms\Components\Grid::make(3)->schema([
                        ...
                        Forms\Components\Select::make('client_id')
                            ...
                            ->options(function ($component) {
                                $clients = Client::where(['active' => true, 'notification' => true]);
                                ...
                                return [0 => __("Select All")] + $clients->pluck('name', 'id')->toArray();
                            })
                            ->live()
